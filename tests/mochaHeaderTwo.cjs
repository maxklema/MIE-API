...
describe("UPLOADING DOCUMENTS - MAPPING TWO", async () => {
    ...
    describe("Documents", async function() {
        ...
        it('Uploading Documents - Header Variation Two', async function() {
            ...
            let expected = ["tests/Upload Test/Documents/Hart_109.txt,null,10019,Success", "tests/Upload Test/Documents/Doe2.htm,null,10019,Success", "tests/Upload Test/Documents/110.txt,null,10019,Success", "tests/Upload Test/Documents/autumn.jpg,null,10019,Success"];
